...
import { FileText, Menu, Palette, X } from "lucide-react";
...
export default function Navbar({
  ...
  return (
    <>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-full border border-panel-border bg-panel px-3 py-1.5 text-xs font-medium text-ink transition-all hover:border-accent hover:text-accent sm:px-3.5"
            ...
            >
              <div className="flex flex-col gap-1 rounded-2xl border border-panel-border bg-canvas/95 p-3 shadow-card backdrop-blur-md">
                ...
                <button
                  ...
                  className="mt-1 flex items-center justify-between rounded-xl border border-accent/20 bg-accent/5 px-4 py-3 text-left text-sm font-medium text-accent"
                >
      ...
      {/* Interactive Resume Modal with View & Download */}
      <ResumeModal
        isOpen={resumeOpen}
